...
**Completed:** 2026-04-17. Shipped `useOrg` composable, `OrgSwitcher`, `OrganizationView`, `CreateOrgView`, and login routing for 0/1/many memberships; `npm test` green (47 tests).
